...
import { WAITLIST_FORM_URL, YOUTUBE_DEMO_URL, YOUTUBE_EMBED_URL } from "./lib/constants";
    ...
    <main className="min-h-screen">
      ...
      <div className="mx-auto flex max-w-7xl gap-6 px-4 py-6 md:px-6 md:py-8">
        ...
        <div className="flex-1 space-y-6">
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="ml-auto flex items-center gap-3">
              <div className="hidden items-center gap-2 md:flex">
                <Link className="rounded-xl bg-white/70 px-3 py-2 text-sm font-semibold text-slate-900 shadow-soft backdrop-blur hover:bg-white dark:bg-white/5 dark:text-white dark:hover:bg-white/10" href="/about">
                  About
                </Link>
                <Link className="rounded-xl bg-white/70 px-3 py-2 text-sm font-semibold text-slate-900 shadow-soft backdrop-blur hover:bg-white dark:bg-white/5 dark:text-white dark:hover:bg-white/10" href="/contact">
                  Contact
                </Link>
                <Link className="rounded-xl bg-white/70 px-3 py-2 text-sm font-semibold text-slate-900 shadow-soft backdrop-blur hover:bg-white dark:bg-white/5 dark:text-white dark:hover:bg-white/10" href="/privacy">
                  Privacy
                </Link>
                <Link className="rounded-xl bg-white/70 px-3 py-2 text-sm font-semibold text-slate-900 shadow-soft backdrop-blur hover:bg-white dark:bg-white/5 dark:text-white dark:hover:bg-white/10" href="/terms">
                  Terms
                </Link>
              </div>
          ...
          <section id="overview" className="rounded-[28px] border border-white/50 bg-white/70 p-6 shadow-soft backdrop-blur md:p-8">
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-4">
              {[
                ...
                >
                  <div className="text-xs text-slate-600 dark:text-white/70">{c.k}</div>
                  <div className="mt-1 text-sm font-semibold text-slate-900 dark:text-white">{c.v}</div>
                </div>
              ))}
            </div>
          </section>
          ...
          <section id="features" className="rounded-[28px] border border-white/50 bg-white/70 p-6 shadow-soft backdrop-blur md:p-8">
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-3">
              {[
                ...
                <div key={f.title} className="glass-card glow-card rounded-3xl p-5 transition hover:-translate-y-0.5">
                  <div className="text-sm font-semibold text-slate-900 dark:text-white">{f.title}</div>
                  <div className="mt-2 text-sm text-slate-600 dark:text-slate-300">{f.desc}</div>
                </div>
              ))}
            </div>
            ...
            <div className="mt-6 grid gap-4">
              {[
                ...
                >
                  ...
                  <div className="mt-3 text-sm text-slate-600 dark:text-slate-200">{item.a}</div>
                </details>
              ))}
            </div>
          </section>
          ...
          >
            <h2 className="text-2xl font-semibold tracking-tight text-slate-900 dark:text-white">Join the waitlist</h2>
            ...
            <div className="glass-card glow-card mt-6 rounded-2xl px-4 py-3 text-xs text-slate-600 dark:text-slate-200">
              ...
              <span className="text-slate-500 dark:text-slate-300"> © 2026 LegalAssist • Built by Asma Ahmed</span>
              <span className="mx-2 text-slate-400">•</span>
              <Link className="text-ink-700 underline decoration-ink-300 underline-offset-4 hover:text-ink-900 dark:text-ink-200 dark:hover:text-white" href="/privacy">
                Privacy
              </Link>
              <span className="mx-2 text-slate-400">•</span>
              <Link className="text-ink-700 underline decoration-ink-300 underline-offset-4 hover:text-ink-900 dark:text-ink-200 dark:hover:text-white" href="/terms">
                Terms
              </Link>
              <span className="mx-2 text-slate-400">•</span>
              <Link className="text-ink-700 underline decoration-ink-300 underline-offset-4 hover:text-ink-900 dark:text-ink-200 dark:hover:text-white" href="/contact">
                Contact
              </Link>
            </div>
          </section>
